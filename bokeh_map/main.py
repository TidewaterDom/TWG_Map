...
sw_data = gpd.read_file(join(dirname(wdir) + 'data/Glacier_locations/Glacier_locations_SW_TRUE.shp'))
nw_data =  gpd.read_file(join(dirname(wdir) + '	data/Glacier_locations/Glacier_locations_NW_TRUE.shp'))
n_data =  gpd.read_file(join(dirname(wdir) + 'data/Glacier_locations/Glacier_locations_N_TRUE_single.shp'))
ne_data =  gpd.read_file(join(dirname(wdir) + 'data/Glacier_locations/Glacier_locations_NE_TRUE.shp'))
se_data =  gpd.read_file(join(dirname(wdir) + 'data/Glacier_locations/Glacier_locations_SE_TRUE.shp'))

# Read in image files for glacier data
path_sw = glob.glob(os.path.join(dirname(wdir)+ 'data/Map_images/SW/*.jpg'))
path_nw = glob.glob(os.path.join(dirname(wdir)+ 'data/Map_images/NW/*.jpg'))
path_n = glob.glob(os.path.join(dirname(wdir)+ 'data/Map_images/N/*.jpg'))
path_ne = glob.glob(os.path.join(dirname(wdir)+ 'data/Map_images/NE/*.jpg'))
path_se = glob.glob(join(dirname(wdir)+ 'data/Map_images/SE/*.jpg'))
