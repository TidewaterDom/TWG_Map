...
nw_data = gpd.read_file('bokeh_map/data/Glacier_locations/Glacier_locations_NWE.shp')
...
path_n = glob.glob('dbokeh_map/data/TWG_images/N/*.jpg')
path_ne = glob.glob('bokeh_map/data/TWG_images/NE/*.jpg')
path_se = glob.glob(j'bokeh_map/data/TWG_images/SE/*.jpg')
